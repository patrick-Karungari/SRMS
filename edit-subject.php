...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['Update'])) {
        $sid = $_GET['subjectCode'];
        $subjectname = $_POST['subjectname'];
        $subjectcode = $sid;
        $subjectsem = $_POST['semester'];
        $subjectyear = $_POST['year'];
        $sql = "update  subjects set subjectName=:subjectname,semCode=:semester,yCode=:year where subjectCode=:subjectcode";
        $query = $dbh->prepare($sql);
        $query->bindParam(':subjectname', $subjectname, PDO::PARAM_STR);
        $query->bindParam(':subjectcode', $subjectcode, PDO::PARAM_STR);
        $query->bindParam(':semester', $subjectsem, PDO::PARAM_STR);
        $query->bindParam(':year', $subjectyear, PDO::PARAM_STR);
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post">
                                                ...
                                                $sql = "SELECT * from subjects where subjectCode=:scode";
                                                $query = $dbh->prepare($sql);
                                                ...
                                                if ($results) {
                                                    foreach ($results as $result) { ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input disabled type="text" name="subjectcode" class="form-control" value="<?php echo htmlentities($result->subjectCode); ?>" id="default" placeholder="Subject Code" required="required">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
