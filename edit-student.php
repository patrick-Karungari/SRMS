...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $year = $_POST['year'];        
        $sql = "update students set fName=:studentname,uniNum=:roolid,email=:studentemail,semCode=:semester,yCode=:year where uniNum=:roolid ";
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post">
                                                <?php
                                                $sql = "SELECT fName,uniNum,email,semCode,yCode from students where uniNum=:stid";
                                                $query = $dbh->prepare($sql);
                                                ...
                                                if ($results) {
                                                    foreach ($results as $result) {  ?>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="fullanme" class="form-control" id="fullanme" value="<?php echo htmlentities($result->fName) ?>" required="required" autocomplete="off">
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="default" class="col-sm-2 control-label">Regidtration Number</label>
                                                            <div class="col-sm-10">
                                                                <input disabled type="text" name="rollid" class="form-control" id="rollid" value="<?php echo htmlentities($result->uniNum) ?>" maxlength="17" required="required" autocomplete="off">
                                                            </div>
                                                        </div>
